...
glitch_exec = {
    ...
    GLITCH_INTERVAL_MAX     : 800, /* millisecs */
    DELAY_BETWEEN_FRAMES    : 50,  /* 30 milisecs delay */
    DELAY_BETWEEN_GLITCHES  : getRandomInt (5000, 13000),
    GLITCH_REFRESH_FRAMES_INTERVAL : 0, /* refresh glitched frames after N glitches ; 0 disables this */
    ...
    __state_machine: function(gl) {
        ...
        if ((0 < gl.glitched_canvases.length) && (gl.rendered_canvases < gl.glitched_canvases.length)) {
            ...
            if (gl.GLITCH_REFRESH_FRAMES_INTERVAL > 0 /*&& --gl.refresh_glitch_frames_counter <= 0*/) {
                gl.glitch_frames();
				window.glitch_exec.GLITCH_REFRESH_FRAMES_INTERVAL = 0;
